...
class Item:
    ...
    _dependency_aware_classes: ClassVar[set] = set()
    ...
    def __init__(self, id: str | None = None, name: str = ""):
        ...
        self.created_at: str = datetime.now().isoformat()  # noqa: DTZ005 -- local-time display bookkeeping, never compared across timezones
    ...
    def update_modified_time(self):
        ...
        self.modified_at = datetime.now().isoformat()  # noqa: DTZ005 -- local-time display bookkeeping, never compared across timezones
    ...
    def from_dict(cls, data: dict[str, Any]) -> "Item":
        ...
        item.created_at = data.get("created_at", datetime.now().isoformat())  # noqa: DTZ005 -- local-time display bookkeeping, never compared across timezones
...
class ItemCollection(Item):
    ...
    def __init__(self, id: str | None = None, name: str = "Collection"):
    ...
    def from_dict(cls, data: dict[str, Any]) -> "ItemCollection":
        ...
        collection.created_at = data.get("created_at", datetime.now().isoformat())  # noqa: DTZ005 -- local-time display bookkeeping, never compared across timezones

...
from pandaplot.gui.components.tabs.sketch.tools.circuit_component_tool import CircuitComponentTool
...
from pandaplot.gui.components.tabs.sketch.tools.wire_tool import WireTool
...
class ToolManager:
    ...
    def __init__(self, canvas: "SketchCanvas"):
        ...
        self.tools: Dict[ToolMode, BaseTool] = {
            ...
            ToolMode.CIRCUIT_COMPONENT: CircuitComponentTool(canvas),
            ToolMode.WIRE: WireTool(canvas),
        }
